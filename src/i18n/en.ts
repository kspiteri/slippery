const en = {
  ...
  verdict: {
    ...
    conditionsAt: 'Conditions at {{point}}',
    ...
    alertBannerUntil: 'MET: {{event}} · until {{time}}',
  },
  tyrePrompt: {
  ...
  headline: {
    clear: 'Roads are looking good, nice day to ride.',
    caution: 'Conditions are mixed, keep it steady and be careful.',
    high: "It's slippery out there! Take it slow and stay safe.",
  ...
  factor: {
    ...
    black_ice: 'black ice risk (refrozen wet road)',
  ...
  howScored: {
    ...
    rules: {
      ...
      blackIce: 'Black ice (wet + sub-zero overnight + near-freezing now)',
